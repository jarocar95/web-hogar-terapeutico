...
export class LoadingStates {
     ...
     */
    showGlobalLoading(show = true, message = 'Cargando...') {
    ...
    hideSkeleton(container, content) {
        ...
        animatedElements.forEach(el => {
            ScrollAnimations.addRevealAnimation(el, 'slide');
        });
    }
    /**
     ...
     */
    createProgress(container, total) {
        container.innerHTML = `
    ...
    updateProgress(container, current, total) {
        ...
        const progressText = container.querySelector('.text-text-muted');
