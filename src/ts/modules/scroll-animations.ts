...
export class ScrollAnimations {
    ...
    setupParallaxEffects() {
        const handleScroll = () => {
            ...
            if (hero) {
                ...
                if (heroBackground) {
                    const speed = 0.5;
                    (heroBackground as HTMLElement).style.transform = `translateY(${scrolled * speed}px)`;
                }
            }
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    items.forEach(item => {
                        ...
                        }, parseInt((item as HTMLElement).style.transitionDelay));
                    });
     ...
     */
    static addRevealAnimation(element: HTMLElement, animationType: 'fade' | 'slide' | 'scale' = 'fade') {
