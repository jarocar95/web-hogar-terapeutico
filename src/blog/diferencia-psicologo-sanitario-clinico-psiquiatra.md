...
faq:
  ...
  - pregunta: "¿Cualquiera puede llamarse terapeuta o coach?"
    respuesta: "«Psicólogo» es un título regulado: exige una formación concreta y colegiación para ejercer en el ámbito sanitario. Palabras como «terapeuta», «coach» o «consultor» no tienen un título oficial equivalente detrás, así que por sí solas no acreditan formación sanitaria. No significa que quien las use no valga: significa que la palabra no te da la información, y conviene preguntar."
  - pregunta: "¿Cómo compruebo que mi psicóloga está colegiada?"
...
Traducido: puede evaluarte y hacer terapia contigo, y tiene el deber de derivarte cuando lo que te ocurre requiere otro nivel de atención. Esa última coma no es un tecnicismo: es una obligación profesional.
...
Es **médico**. Estudia Medicina y se especializa en psiquiatría por la vía MIR, con su propia residencia.

Su diferencia práctica más importante, y la que de verdad te interesa: **es el único de los tres que puede recetar medicación.** También diagnostica y trata trastornos mentales, y en cuadros graves suele ser quien coordina.
...
La pregunta es sencilla y no es grosera: *¿cuál es tu formación y tu número de colegiado?*

## Cómo comprobarlo en dos minutos

Pide el número de colegiado y contrástalo. Cada [Colegio Oficial de la Psicología](https://www.copmadrid.org) mantiene un registro público de colegiados, y comprobarlo es gratis.

Es una pregunta completamente normal. Cualquier profesional te la responde sin incomodarse: yo la contesto antes de que me la hagas, porque mi número está en la cabecera de esta web. Es el **M-42569**, del Colegio Oficial de la Psicología de Madrid.

Si alguien se pone a la defensiva ante esa pregunta, eso ya es una respuesta.
...
Los dos peros, dichos sin adornos:

* **Los tiempos de espera varían mucho** entre comunidades autónomas y suelen ser largos, tanto para la primera cita como entre sesiones. Una terapia con citas muy espaciadas funciona distinto que una semanal.
* **La atención se prioriza por gravedad**, que es como debe ser en un sistema con recursos limitados. Si lo tuyo no es un cuadro grave, es probable que esperes más.

Si puedes esperar y el coste es un problema, la vía pública es una opción perfectamente legítima y no tienes que justificarla ante nadie. Si necesitas empezar ahora o quieres una frecuencia sostenida, ahí es donde la privada tiene sentido. No es una cuestión de calidad: es de acceso y de ritmo.

## Entonces, ¿a quién acudo?

Sin conocerte no puedo decírtelo, pero sí puedo darte el criterio que usaría yo:
